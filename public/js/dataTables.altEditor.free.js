       ...
       _openDeleteModal: function ()
       {
         ...
         for( var i = 0; i < dt.context[0].aoColumns.length; i++ )
         {
          ...
          for (var i in columnDefs) {
            ...
            data += "<div class='form-group'><label for='" + columnDefs[i].title + "'>" + columnDefs[i].title + " : </label><input  type='hidden'  id='" + columnDefs[i].title + "' name='" + columnDefs[i].title + "' placeholder='" + columnDefs[i].title + "' style='overflow:hidden'  class='form-control' value='" + columnDefs[i].data + "' >" + columnDefs[i].data + "</input></div>";
